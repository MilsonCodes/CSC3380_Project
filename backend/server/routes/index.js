...
export default app => {
  ...
  app.post("/api/favorite/:specialId/:userId", Users.favorite); // Route for favoriting a special
  app.get("/api/favorites/:userId", Users.getFavorites); // Route for getting the favorites list
