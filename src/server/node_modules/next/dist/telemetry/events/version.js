...
if(typeof "9.1.2"!=='string'){return[];}return[{eventName:EVENT_VERSION,payload:{nextVersion:"9.1.2",nodeVersion:process.version,cliCommand:event.cliCommand,isSrcDir:event.isSrcDir}}];}